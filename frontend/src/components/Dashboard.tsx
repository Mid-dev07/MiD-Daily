...
export function Dashboard({ tasks, schedule, finance, onToggleTask }: DashboardProps) {
    ...
    <div className="dashboard-grid">
      <section className="welcome-card">
        ...
        <div className="welcome-date">
          <strong>{new Intl.DateTimeFormat('en-US', { weekday: 'long' }).format(new Date())}</strong>
          <span>{new Intl.DateTimeFormat('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }).format(new Date())}</span>
        </div>
      </section>
