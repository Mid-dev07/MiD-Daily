...
const inThreeDays = offsetDate(3)
...
export const initialTasks: Task[] = [
  ...
  { id: 2, title: 'Finish database schema draft', category: 'Project', priority: 'high', status: 'todo', dueDate: tomorrow, notes: 'Draft the first multi-user schema and ownership rules.', progress: 25 },
  { id: 3, title: 'Study TypeScript fundamentals', category: 'Learning', priority: 'medium', status: 'todo', dueDate: inThreeDays, notes: 'Continue types, generics, and strict mode exercises.', progress: 10 },
