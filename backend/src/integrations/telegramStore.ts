...
const telegramDatabaseClient = SUPABASE_URL && SUPABASE_SECRET_KEY
...
function db() {
  if (!telegramDatabaseClient) throw new Error('Supabase persistence is not configured.')
  return telegramDatabaseClient
}
